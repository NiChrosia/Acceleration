...
function statusZone() {
    if (!Vars.state.paused) {
        mevents.puddleStatusEffectZone(msfx.arctifreezing, mfx.arctifreezeSquare, mfx.arctifreezeLineSquare, mfx.arctifrozen, 48, mliquids.arctifluid, false, new Seq);
